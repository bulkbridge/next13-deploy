                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <a
                      ...
                      target="_blank"
                    >
                      Dream diary, Velur kuttamkulam, Thrissur,680322
                    </a>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span>
                  <a href="tel:+91 90722 84664">tel:+91 90722 84664</a>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span>
                  <a href="mailto:dreamdiary@gmail.com">E: dreamdiary@gmail.com</a>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-xl-4 col-lg-5">
              <div className="tp-copyright-2-left text-center text-lg-start">
                <p>
                  All rights reserved — {new Date().getFullYear()} ©dreamdiary
                </p>
              </div>
            </div>
